        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <div className="flex-1">
                <input
                  ...
                  className="w-full p-2 text-sm border rounded-md border-[#FF0000]/20 focus:outline-none focus:ring-2 focus:ring-[#FF0000]/20"
                />
              </div>
              <div className="flex gap-2">
                <Button
                  ...
                  className="flex-1 sm:flex-none text-[#FF0000] border-[#FF0000]/20 hover:bg-[#FF0000] hover:text-white"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2 mt-2">
              <div className="flex justify-between items-center p-4 bg-[#FF0000]/5 rounded-lg border border-[#FF0000]/20">
