      ...
      <CardContent className="p-6">
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-3">
            <div className="p-2.5 rounded-xl bg-[#EBBA07]/10">
              <PiggyBank className="w-5 h-5 text-[#EBBA07]" />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 rounded-xl bg-[#EBBA07]/5 border border-[#EBBA07]/10">
              <div className="flex items-center gap-2 mb-2">
                <Timer className="w-4 h-4 text-[#EBBA07]" />
              ...
              <div className="mt-2 p-2 bg-[#EBBA07]/10 rounded-lg text-xs text-gray-600">
            ...
            <div className="p-4 rounded-xl bg-[#EBBA07]/5 border border-[#EBBA07]/10">
              <div className="flex items-center gap-2 mb-2">
                <ArrowUpRight className="w-4 h-4 text-[#EBBA07]" />
                <p className="font-semibold">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2 text-sm">
                <div className="w-2 h-2 rounded-full bg-[#EBBA07]"></div>
                <p>
                  {language === "es"
          ...
          <div className="p-4 rounded-xl bg-gray-50 border border-gray-200">
            <div className="flex items-start gap-2">
              <AlertCircle className="w-5 h-5 text-[#EBBA07] shrink-0 mt-0.5" />
              <div className="space-y-2">
                <p className="font-medium">
                  {language === "es"
